...
if __name__ == '__main__':
    ...
    parser.add_argument("--base_path", type=str, help="Base path for the project data")
    parser.add_argument("--video_input_dir", type=str, help="Directory containing input videos")
    parser.add_argument("--feats_save_dir", type=str, help="Directory to save extracted features")
    parser.add_argument("--config_path", type=str, help="Path to config file")
    parser.add_argument("--intern_video2_path", type=str, help="Path to InternVideo2 model checkpoint")
    parser.add_argument("--bert_large_uncased_path", type=str, help="Path to BERT pretrained model")
    ...
    classifier = InternVideo2VideoClassifier(base_path, class_dirs_cn, class_dirs_en, args.config_path, args.intern_video2_path,
                                             args.bert_large_uncased_path, args.video_input_dir, args.feats_save_dir)
